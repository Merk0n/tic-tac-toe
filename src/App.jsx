...
function App() {
    ...
    const acceptButtonStyle =
        'rounded-lg border-2 border-gray-800 bg-green-200 p-1 hover:bg-green-300 active:bg-green-400';
    ...
    return (
        <>
            ...
            {/* footer */}
            <footer className='relative inset-x-0 bottom-0 flex w-full items-center justify-center gap-1 text-lg lg:text-xl'>
